 ...
 * @author wangxun
 */
public class AIManagerHttpUtil {
    ...
    public static String sendMessage(List<LLMMultiModalMessage> llmMessages,AppProperties appProperties) throws IOException, InterruptedException {
        ...
        return resultStr;//getMessage(resultStr);
...
//            String story = AIManagerHttpUtil.sendMessage(llmMessages);
//            return story;
//        } catch (IOException e) {
...
//    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            appProperties.setDeployType("public");
            appProperties.setAiManagerAddress("http://10.101.129.2:8080");
            appProperties.setAiManagerApiKey("ovJBqNn8zFAOD26KGTAdEArgMJinyd3HudXRmrpQEmNuVl3FWA");
...
//            llmMessages.add(systemMessage);
            ...
            String story = AIManagerHttpUtil.sendMessage(llmMessages,appProperties);
