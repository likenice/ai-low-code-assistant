...
//import com.fasterxml.jackson.databind.node.ObjectNode;表格
//import com.seeyon.ai.schematransformer.dto.NodePosition;
//import com.seeyon.ai.schematransformer.dto.OcrGroupType;
//import com.seeyon.ai.schematransformer.dto.UdcSchemaDto;
...
// */
//@Slf4j
//public class SchemaTransformerSelf {
//
//    @Data
...
//
//
//    public static UdcSchemaDto convertUdc2Dto(JsonNode udcSchema){
//
//        UdcSchemaDto udcSchemaDto = new UdcSchemaDto();
//        ObjectNode udcSchemaCopy = (ObjectNode)udcSchema.deepCopy();
//
//        JsonNode childrenNode = udcSchemaCopy.get("children");
//        ObjectNode childByIdNode = (ObjectNode)udcSchemaCopy.get("childById");
//
//        udcSchemaDto.setSourceNode(udcSchema);
//        udcSchemaDto.setChildren((ArrayNode) childrenNode);
//
//        childByIdNode.fieldNames().forEachRemaining(
//             fieldName -> {
//                 childByIdNode.put(fieldName, childByIdNode.get(fieldName));
//             }
//        );
//
//        udcSchemaCopy.remove("childById");
//        udcSchemaCopy.remove("children");
//        udcSchemaDto.setRootNode(udcSchemaCopy);
//
//        return udcSchemaDto;
//    }
//
...
//
//        UdcSchemaDto udcSchemaDto = convertUdc2Dto(template);
//
...
////        try {
//        dslSchema.put("id", template.get("id").asText() );
//        dslSchema.put("type", "page");
//        dslSchema.put("pageType",template.get("pageType"));
//        dslSchema.put("urlType", template.get("urlType"));
//
//        // 设置 settings
//        ObjectNode settings = dslSchema.putObject("settings");
//        settings.put("dataFrom", "convert");
//
//        // 设置 sourceSchema
//        dslSchema.set("sourceSchema",template);
//        ArrayNode childrens = mapper.createArrayNode();
//        dslSchema.set("children", childrens);
//
//        ArrayNode children = udcSchemaDto.getChildren();
//        Map<String, JsonNode> childByIdMap = udcSchemaDto.getChildByIdMap();
//        for (JsonNode child : children) {
//            String childId = child.asText();
//            JsonNode jsonNode = childByIdMap.get(childId);
//            if (jsonNode != null) {
//                ObjectNode currNode = mapper.createObjectNode();
//                childrens.add(currNode);
//                // 将jsonNode节点插入dslSchema的childrens属性
//                processNode(childId,udcSchemaDto,currNode);
//
//            }
//        }
//        // 处理 children
...
//     * @param currNode
//     */
//    public static void processNode(String nodeId, UdcSchemaDto udcSchemaDto, ObjectNode currNode){
//        JsonNode jsonNode = udcSchemaDto.getChildByIdMap().get(nodeId);
//        ObjectMapper mapper = new ObjectMapper();
//        ArrayNode currNodeChildrenNdoes = mapper.createArrayNode();
//
//        if (jsonNode != null) {
//            //TODO 转换节点.
//            currNode = null;
...
//                        String childId = child.asText();
////                        currNode.put
////                        processNode(childId, udcSchemaDto, currNodeChildrenNdoes);
//                    }
//                );
//
//
...
////        parentNode.put("id", parent.get("id").asText());
//        // 设置转换后的type
//        if (parent.has("type")) {
//
...
//            SchemaTransformerUtil.insertNodeProps( parentSettings,settingsNode, Arrays.asList("gridTemplateColumns","gridTemplateRows"));
//
//            ArrayNode childrenArray = parentNode.putArray("children");
//
